...
# Funktionen für Kanten: 
    ...
    def setKantenAttribut(self, start, ziel, attrName, attrWert):
        '''
            Die durch start und ziel spezifizierte Kante erhält für das angegebene Attribut den angegebenen Wert
        '''
    ...
    def alleNachbarknoten(self, start):
        '''
            Eine Liste der Nachbarknoten des angegebenen Knoten wird geliefert
        '''
